// src/index.js
import { mkdir as mkdir4, readFile as readFile2, realpath, rename as rename4, stat, unlink, writeFile as writeFile4 } from "node:fs/promises";
  ...
  async function moveOne(sid, targetPath) {
    ...
    const relocateLog = async (header, newHeaderObj) => {
      ...
      try {
        ...
        await writeFile4(stagedPath, rewritten, { mode: 384 });
        await rename4(stagedPath, newPath);
